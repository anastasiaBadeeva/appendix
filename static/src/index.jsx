 ...
 <Router>
  <Switch>
   <Route
    ...
    path="/"
    render={() =>
     !isLoggedIn() ? <Redirect to="/signin" /> : <Redirect to="/dashboards" />
    }
   />
   ...
   {/* check docs */}
   <Route path={'/appendix/:tabName'} component={Appendix} />
   ...
   />
   <Route render={() => <MainScreen isLogged={isLoggedIn()} type="empty" />} />
  </Switch>
 </Router>,
